...
public class JwtTokenProvider {
    ...
    public String getAllContentsFromJWT(String token) throws JsonProcessingException{
        ...
        allValues.put("id", (String)claims.get("id"));
        allValues.put("username", (String)claims.get("username"));
        allValues.put("fullName", (String)claims.get("username"));
        String json_value = new ObjectMapper().writeValueAsString(allValues);
        return json_value;
    }
